...
<header class="nh-header" role="banner">
  ...
  <div class="nh-topbar">
    <div class="nh-container nh-topbar__inner">
      <div class="nh-topbar__left">
        <span class="nh-topbar__brand">WAVE NEWS</span>
      ...
      <nav class="nh-topbar__links" aria-label="유틸리티 메뉴">
        <c:choose>
          ...
          <c:otherwise>
            ...
            <a href="<c:url value='/member/joinForm.do'/>">회원가입</a>
          </c:otherwise>
        </c:choose>
      </nav>
    </div>
  ...
  <div class="nh-masthead">
    <div class="nh-container nh-masthead__inner">
      ...
      <form class="nh-search" role="search" method="get" action="<c:url value='/board/listArticles.do'/>">
        <label class="sr-only" for="q">검색</label>
        <input id="q" name="q" type="search" placeholder="검색어를 입력하세요" value="${param.q}"/>
        <button type="submit" class="nh-btn">검색</button>
      </form>

      <button id="nh-burger" class="nh-burger" aria-expanded="false" aria-controls="nh-primary">
        <span class="sr-only">메뉴 열기</span>
        <span class="nh-burger__bar" aria-hidden="true"></span>
        <span class="nh-burger__bar" aria-hidden="true"></span>
        <span class="nh-burger__bar" aria-hidden="true"></span>
      </button>
    </div>
  ...
  <!-- Primary Nav -->
  <nav id="nh-primary" class="nh-nav" role="navigation" aria-label="주요 카테고리">
    <div class="nh-container">
      <ul class="nh-nav__list">
        <li class="nh-nav__item ${curCat=='politics' ? 'is-active' : ''}">
          <button class="nh-nav__btn" aria-expanded="false" data-target="sub-politics">정치</button>
        </li>
        <li class="nh-nav__item ${curCat=='economy' ? 'is-active' : ''}">
          <button class="nh-nav__btn" aria-expanded="false" data-target="sub-economy">경제</button>
        </li>
        <li class="nh-nav__item ${curCat=='society' ? 'is-active' : ''}">
          <button class="nh-nav__btn" aria-expanded="false" data-target="sub-society">사회</button>
        </li>
        <li class="nh-nav__item ${curCat=='culture' ? 'is-active' : ''}">
          <button class="nh-nav__btn" aria-expanded="false" data-target="sub-culture">문화</button>
        </li>
        <li class="nh-nav__item ${curCat=='world' ? 'is-active' : ''}">
          <button class="nh-nav__btn" aria-expanded="false" data-target="sub-world">국제</button>
        </li>
        <li class="nh-nav__item ${curCat=='sports' ? 'is-active' : ''}">
          <button class="nh-nav__btn" aria-expanded="false" data-target="sub-sports">스포츠</button>
        </li>
        <li class="nh-nav__item ${curCat=='tech' ? 'is-active' : ''}">
          <button class="nh-nav__btn" aria-expanded="false" data-target="sub-tech">IT/과학</button>
        </li>
      </ul>
    </div>
    ...
    <div class="nh-mega" aria-live="polite">
      ...
      <div class="nh-mega__row" id="sub-tech">
        ...
        <a class="chip${curCat=='tech' && curSub=='science'? ' active' : ''}"
